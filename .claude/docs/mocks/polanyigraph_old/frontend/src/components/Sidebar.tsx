    ...
    >
      ...
      <div className="w-16 shrink-0 border-r border-zinc-800/80 bg-zinc-950/40 flex flex-col items-center py-4 justify-between select-none">
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center gap-1 group relative w-full py-1 transition-all ${
                  isSelected ? 'text-blue-400' : 'text-zinc-200 hover:text-white'
                }`}
              >
                <div
                  className={`p-1.5 rounded transition-colors ${
                    isSelected ? 'bg-blue-500/10 text-blue-400' : 'text-zinc-200 group-hover:text-white'
                  }`}
                >
                ...
                {isSelected && (
                  <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[2px] h-6 bg-blue-500 rounded-l" />
                )}
              </button>
            );
          })}
        ...
        <button
          ...
          className="p-1.5 rounded text-zinc-200 hover:text-white hover:bg-zinc-900 transition-colors"
