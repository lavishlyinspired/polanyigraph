    ...
    <div className="h-full flex-1 flex overflow-hidden bg-zinc-950">
        ...
        <div className="p-4 bg-zinc-900/10 space-y-3 shrink-0">
          ...
          <div className="grid grid-cols-2 gap-2">
            <input
              ...
              className="bg-zinc-900 border border-zinc-800 rounded-lg text-xs text-white placeholder:text-zinc-700 px-2.5 h-8.5 focus:outline-none focus:border-blue-500"
            />
            <input
              value={bfsTarget}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-4 border-b border-zinc-800 bg-zinc-900/10 shrink-0 flex items-center justify-between">
          ...
          <span className="px-2.5 py-1 rounded text-[10px] bg-blue-500/10 border border-blue-500/20 text-blue-400 font-mono font-bold">
