      ...
      <div className="w-[420px] border-r border-zinc-800 flex flex-col min-w-0 bg-zinc-950/20">
        ...
        <div className="p-4 border-t border-zinc-800 bg-zinc-900/10 space-y-2.5">
          ...
          <div className="space-y-2">
            ...
            >
              <Plus className="w-3.5 h-3.5 text-blue-400" /> Inject Concept to Store
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-5 min-h-0">
          ...
          <div className="grid grid-cols-12 gap-5">
            ...
            <form onSubmit={handleAddRule} className="col-span-12 lg:col-span-5 p-4 rounded-xl border border-zinc-800 bg-zinc-950/40 space-y-3">
              ...
              <button
                type="submit"
                className="w-full h-9.5 mt-2 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-lg flex items-center justify-center gap-1.5 transition-all shadow-md shadow-blue-500/10"
              >
              ...
              <div className="space-y-3">
                ...
                <div className="text-[11px] text-zinc-400 space-y-2 leading-relaxed">
                  ...
                  <div className="p-2.5 rounded border border-zinc-800 bg-zinc-950 font-mono text-[10px] text-zinc-300">
                    <span className="text-amber-400">hasActivation(S, Act)</span>, <span className="text-emerald-400">Act &gt; Threshold</span>, <span className="text-sky-400">predicate(S, T)</span> <br />
                    <span className="text-zinc-500">→</span> <span className="text-sky-400 font-bold">impliesRelation(S, T, edgeType)</span>
                  </div>
                  <p>When the neural spreading activation step floods nodes, if any concept of type <strong className="text-zinc-300">Premise Type</strong> passes the <strong className="text-blue-400">Activation Limit Bound</strong>, the symbolic compiler fires this rule over matching ontology paths, creating derived edges and feeding back activation into targets.</p>
                </div>
              </div>
