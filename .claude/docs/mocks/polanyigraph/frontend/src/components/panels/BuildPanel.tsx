  ...
  return (
    <div className="h-full flex flex-col bg-zinc-950 text-zinc-100 overflow-hidden">
      ...
      <div className="border-b border-zinc-800">
        ...
        >
          <div className="flex items-center gap-2">
            <FileText className={`w-3.5 h-3.5 ${section === 'ingest' ? 'text-indigo-400' : 'text-zinc-500'}`} />
      ...
      <div className="border-b border-zinc-800">
        ...
        >
          <div className="flex items-center gap-2">
            <Layers className={`w-3.5 h-3.5 ${section === 'construct' ? 'text-indigo-400' : 'text-zinc-500'}`} />
      ...
      <div className="border-b border-zinc-800">
        ...
        >
          <div className="flex items-center justify-between w-full pr-1">
            <div className="flex items-center gap-2">
              <Sparkles className={`w-3.5 h-3.5 ${section === 'enrich' ? 'text-indigo-400' : 'text-zinc-500'}`} />
              <span>3. Cognitive Enrichment</span>
            </div>
            <div className="flex items-center gap-2">
              {pendingFacts.length > 0 && (
                <span className="px-1.5 py-0.5 rounded-full bg-indigo-500/10 border border-indigo-500/25 text-indigo-400 text-[9px] font-bold">
